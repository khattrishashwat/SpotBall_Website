...
const GeolocationPopup = ({ contests, onClose }) => {
  ...
  //             const { restrictedStates } = contests; // Ensure contests is in scope

  //             if (
  //               restrictedStates.includes(stateName) ||
  //               restrictedStates.includes(countryName)
  //             ) {
        ...
        async (position) => {
          ...
          try {
            ...
            if (response.data.results && response.data.results.length > 0) {
              ...
              const { restrictedStates } = contests || { restrictedStates: [] }; // Ensure contests is in scope

              // Check if restrictedStates is defined and an array
              if (
