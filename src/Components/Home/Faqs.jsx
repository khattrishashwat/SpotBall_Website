  ...
  const faqData = [
    {
      ...
      answer: `Participation in SpotsBall contests (conducted as part
        of the Game) is open to the Users, comprising Indian
        residents which meet the eligibility and age
        requirements stipulated in the Terms and Conditions...`,
    },
    {
      question: "Will I get a confirmation of my x, y entry coordinates?",
      answer: `Absolutely. Shortly after submission of an entry in an
        ongoing weekly contest, you will receive an email or text message...`,
    },
    {
      question: "How do I play?",
      answer: `For each SpotsBall contest, the Company will post an action photo of a
        cricket match, with a masked “hot zone” overlay...`,
    },
  ];
  return (
    <>
